...
import sys
sys.path.append('/home/lei/libsvm-3.18/tools/')
from grid import *
...
def runWholeProcess():
    ...
    train_data_folder7 = '/home/lei/test_data/svm_random_test/tictac_test/test_set_7/train/'
    test_data_folder7 = '/home/lei/test_data/svm_random_test/tictac_test/test_set_7/test/'
    model_folder7 = '/home/lei/test_data/svm_random_test/tictac_test/test_set_7/model/'
    percents = [0.25,0.5,0.75,1.0]
    ######################
    
    train_data_folder = train_data_folder7
    test_data_folder =test_data_folder7
    model_folder = model_folder7
    num_of_training_data = 600
